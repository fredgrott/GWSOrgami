...
package com.grottworkshop.gwsmaterialpagerslidingtabstrip;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        //TODO: need easy way to do this if someone is loading roboto medium fonts prior to api 21
    ...
    /**
     *
     * @param color_state_default the default color state
    ...
    /**
     *
     * @param color_state_pressed the color state pressed
     * @param color_state_selected the color state selected
     * @param color_state_default the default color state
     * @return the ColorStateList
     */
